    ...
    <nav className="relative flex flex-col gap-4 bg-white shadow shadow-accent z-50">
      <div className="w-full">
        ...
        <div className="container relative flex items-center justify-end">
          <Link
            className="rounded-b-lg text-white text-sm font-medium flex max-w-48 justify-center 
                  relative right-1/2 translate-x-1/2 sm:translate-x-0 sm:right-[18%]"
            href="/"
          >
      ...
      <div className="pb-11 bg-white z-20">
        <div className="container px-4 relative flex items-center justify-between gap-8 xl:gap-10">
          ...
          >
            ...
            <div
              className="hidden xl:flex col-span-2 h-18 items-center justify-between gap-2 
                  p-4 py-3 shadow-[0px_0px_20px_0px_#000] shadow-muted-foreground/30 rounded-xl"
            >
